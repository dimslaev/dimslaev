...
// Look up by a slash-insensitive path so this keeps working if the
// trailingSlash setting is ever flipped.
...
export default defineConfig({
  ...
  integrations: [
    sitemap({
      serialize(item) {
        const date = lastmod.get(normalize(new URL(item.url).pathname));
